...
container: {
  ...
  maxWidth: "350px",    // limit max size for larger screens
  minHeight: "350px",
},
  cardHover: {
...
margin:"3px",
  ...
  arrowLeft: { position: "absolute", top: "50%", left: "-25px", transform: "translateY(-50%)", background: "#f9f9f970", color: "#007bff", border: "none", borderRadius: "50%", width: "35px", height: "35px", cursor: "pointer", zIndex: 10 },
  arrowRight: { position: "absolute", top: "50%", right: "-25px", transform: "translateY(-50%)", background: "#f9f9f9d9", color: "#007bff", border: "none", borderRadius: "50%", width: "35px", height: "35px", cursor: "pointer", zIndex: 10 },
